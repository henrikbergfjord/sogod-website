...
<article class="card"><div class="photo" style="background-image:url('/assets/images/atv-hero.jpg')"></div><div class="card-body"><div class="kicker">Adventure</div><h3>Mayon ATV adventure</h3><p>A memorable way to experience the landscape around Mayon. Route, operator and availability are confirmed before booking.</p><a href="/experiences/mayon-atv.html">See details →</a></div></article>
<article class="card"><div class="photo" style="background-image:url('/assets/images/beaches-hero.jpg')"></div><div class="card-body"><div class="kicker">Water & nature</div><h3>Beach day</h3><p>Slow the pace down with a day by the water. We can help plan transport and practical details around your stay.</p><a href="/experiences/beach-day.html">See details →</a></div></article>
<article class="card"><div class="photo" style="background-image:url('/assets/images/food-culture-hero.jpg')"></div><div class="card-body"><div class="kicker">Food</div><h3>Local food & flavours</h3><p>Discover Bicol flavours through local meals and food experiences, with options confirmed according to your dates.</p><a href="/experiences/bicol-food.html">See details →</a></div></article>
...
<article class="card"><div class="photo" style="background-image:url('/assets/images/arrival-hero.jpg')"></div><div class="card-body"><div class="kicker">Arrival</div><h3>Airport pickup</h3><p>Start the stay more smoothly with planned transport from the airport. Vehicle and timing are confirmed for your request.</p><a href="/experiences/airport-pickup.html">See details →</a></div></article>
