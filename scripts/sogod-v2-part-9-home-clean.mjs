...
a{color:inherit}
.page{min-height:100vh;background:linear-gradient(180deg,rgba(5,31,25,.14),rgba(5,31,25,.10) 55%,rgba(5,31,25,.26)),url('/assets/images/dorian-villa-hero.jpg') center 44%/cover no-repeat fixed;position:relative}
.page:before{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(90deg,rgba(2,20,16,.74) 0%,rgba(2,20,16,.46) 28%,rgba(2,20,16,.10) 55%,rgba(2,20,16,.02) 100%)}
...
.card.stay{background:url('/assets/images/dorian-villa-hero.jpg') center 56%/cover no-repeat}
